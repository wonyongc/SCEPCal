...
//===============================
#ifndef SCEPCal_TimingSegmentation_h
#define SCEPCal_TimingSegmentation_h 1
...
class SCEPCal_TimingSegmentation : public Segmentation {
    public:
        SCEPCal_TimingSegmentation(const std::string& aCellEncoding);
        SCEPCal_TimingSegmentation(const BitFieldCoder* decoder);
        virtual ~SCEPCal_TimingSegmentation() override;
