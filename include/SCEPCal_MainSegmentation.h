...
//===============================
#ifndef SCEPCal_MainSegmentation_h
#define SCEPCal_MainSegmentation_h 1
...
class SCEPCal_MainSegmentation : public Segmentation {
    public:
        SCEPCal_MainSegmentation(const std::string& aCellEncoding);
        SCEPCal_MainSegmentation(const BitFieldCoder* decoder);
        virtual ~SCEPCal_MainSegmentation() override;
